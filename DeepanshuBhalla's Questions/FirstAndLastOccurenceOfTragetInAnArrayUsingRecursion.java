...
public class FirstAndLastOccurenceInArrayUsingRecursion {
    ...
    public static void main(String[] args) {
        int target = 20;
        int[] arr = {10, 20, 30, 20,20, 40};
        Arrays.sort(arr);
      // IterativeOccurenceFinder(arr,target);
        int first_index = 0;
        System.out.println(FindFirstOccurenceRecursively(arr,first_index,target));
        System.out.println(FindLastOccurenceRecursively(arr,arr.length-1,target));
    }
}
